 ...
 * |------+------+------+------+------+------+------+------+------+------+------+------|
 * |      | ACL2 | VOLU | PREV |PAUSE | NEXT |   =  |   =  |   1  |   2  |   3  | Back |
 * |------+------+------+------+------+------+------+------+------+------+------+------|
 * |      |Symbol| VOLD | MUTE | Bksp | Space|Space | Del  |   0  |   0  |   .  |      |
 * `-----------------------------------------------------------------------------------'
 */
[_NUMPAD] = LAYOUT_preonic_grid( \
	KC_GRV,		_______,	_______,	KC_BTN3,	_______,	_______,	_______,	_______,	KC_NLCK,	KC_SLSH,	KC_ASTR,	TD(BkMin), \
	_______,	KC_ACL0,	KC_BTN1,	KC_MS_U,	KC_BTN2,	KC_WH_U,	KC_ASTR,	KC_PLUS,	KC_7,		KC_8,		KC_9,		KC_PLUS, \
	_______,	KC_ACL1,	KC_MS_L,	KC_MS_D,	KC_MS_R,	KC_WH_D,	KC_SLSH,	KC_MINS,	KC_4,		KC_5,		KC_6,		KC_ENT, \
	_______,	KC_ACL2,	KC_VOLU,	KC_MPRV,	KC_MPLY,	KC_MNXT,	KC_EQL,		KC_EQL,		KC_1,		KC_2,		KC_3,		_______, \
