 ...
 * |------+------+------+------+------+------+------+------+------+------+------+------|
 * | Ctrl |  Alt | Cmd  |CtlDel| Bksp | Space|Space |  Del | Left | Down |  Up  |Right |
 * `-----------------------------------------------------------------------------------'
 */
[_QWERTY] = LAYOUT_preonic_grid( \
	...
	TD(CtlTsk), KC_LALT,	KC_LGUI,LCTL_T(KC_DEL),	KC_BSPC,	KC_SPC,	KC_SPC,	KC_DEL,	KC_LEFT,	KC_DOWN,	KC_UP,		KC_RGHT  \
),
...
[_COLEMAK] = LAYOUT_preonic_grid( \
	...
	OSL(_SYMB), KC_LCTL,	KC_LALT,	KC_BSPC,	KC_BSPC,	KC_SPC,	KC_SPC,	KC_DEL,	KC_LEFT,	KC_DOWN,	KC_UP,		KC_RGHT \
),
 ...
 * |      |      |      |      |      |      |   =  |   0  |   .  |   *  |  /   | Back |
 * |------+------+------+------+------+------+------+------+------+------+------+------|
 * |Symbol|      |      |      |      |BkSpce|Space |Space | Left | Down |  Up  |Right |
 * `-----------------------------------------------------------------------------------'
 */
