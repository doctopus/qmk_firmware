...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
   ...
   * |-------------------------------------------------------------------------+
   * | Ctrl| Ctrl | Alt | GUI |  L2  |   Space   |  L1  | L3| Left|Down|Right|
   * `-------------------------------------------------------------------------'
   */
...
LAYOUT(
  ...
  KC_LCTL, KC_LCTL, KC_LALT, KC_LGUI,  MO(2),      KC_SPC,        MO(1),  MO(3),   KC_LEFT, KC_DOWN, KC_RGHT
),
/*---------------------------------------------------------------------------------*/
  /* FN Layer 1
   * ,-------------------------------------------------------------------------.
...
/*---------------------------------------------------------------------------------*/
  /* FN Layer 3
   * ,-------------------------------------------------------------------------.
   * |RESET| Calc|Webhm| Mail| Comp|     |     |     |     |     |PrtSc|       |
   * |-------------------------------------------------------------------------+
   * |      |     |     |     |     |     |     |     |     |     |     |      |
   * |-------------------------------------------------------------------------+
   * |       |    |     |     |     |     |     |     |     |     |     |     |
