 ...
 * ├──────┴┬─────┴┬─────┴┬─────┴┬─────┴┬─────┴┐     └─┬───┴─┬────┴─┬─────┴┬─────┴┬─────┴┬───┴─────┤
 * │Tab(L2)│  A   │  S   │  D   │  F   │  G   │       │  H  │   J  │  K   │  L   │ ;    │Enter(L1)│
 * ├───────┴──┬───┴──┬───┴──┬───┴──┬───┴──┬───┴──┐  ┌─┴───┬─┴───┬──┴──┬───┴──┬───┴──┬───┴──┬──────┤
 * │ LSHFT    │  Z   │  X   │  C   │  V   │  B   │  │  "  │  N  │  M  │  ,   │  .   │  /   │Shift │
 * ├───────┬──┴─────┬┴─────┬┴──────│──────┴──────│  │─────┴─────┴┬────┴───┬──┴───┬──┴────┬─┴──────┤
 * │ LCTRL │   Win  │      │ LAlt  │BackSpace(L2)│  │ Space(L1)  │   Del  │      │  RAlt │  RCtrl │
 * └───────┴────────┘      └───────┴─────────────┘  └────────────┴────────┘      └───────┴────────┘
 */
  [0] = LAYOUT(
    KC_ESC,        KC_Q,    KC_W, KC_E,     KC_R,    KC_T,     KC_Y,       KC_U,    KC_I,    KC_O,    KC_P,    KC_DEL, KC_BSPC,
    LT(2, KC_TAB), KC_A,    KC_S, KC_D,     KC_F,    KC_G,     KC_H,        KC_J,    KC_K,    KC_L,    KC_SCLN, LT(1, KC_ENT),
    KC_LSFT,       KC_Z,    KC_X, KC_C,     KC_V,    KC_B,  LT(3, KC_QUOT), KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, KC_RSFT,
    KC_LCTL,       KC_LGUI,       KC_LALT,  LT(2, KC_BSPC),    LT(1, KC_SPC),        KC_DEL,          KC_RALT, KC_RCTL
  ),
 ...
 * │   ~  │  !   │  @   │  #   │  $   │  %   │      │  ^  │  &   │   *   │  (   │   )  │ Del│ Bksp│  
 * ├──────┴┬─────┴┬─────┴┬─────┴┬─────┴┬─────┴┐     └─┬───┴─┬────┴─┬─────┴┬─────┴┬─────┴┬───┴─────┤
 * │Tab(L2)│  _  │  +   │  D   │  F   │  G   │       │  H  │   J  │  K   │  L   │ ;    │Enter(L1)│
 * ├───────┴──┬───┴──┬───┴──┬───┴──┬───┴──┬───┴──┐  ┌─┴───┬─┴───┬──┴──┬───┴──┬───┴──┬───┴──┬──────┤
 * │ LSHFT    │  Z   │  X   │  C   │  V   │  B   │  │  "  │  N  │  M  │  ,   │  .   │  /   │Shift │
 * ├───────┬──┴─────┬┴─────┬┴──────│──────┴──────│  │─────┴─────┴┬────┴───┬──┴───┬──┴────┬─┴──────┤
 * │ LCTRL │   Win  │      │ LAlt  │BackSpace(L2)│  │ Space(L1)  │   Del  │      │  RAlt │  RCtrl │
