...
qk_tap_dance_action_t tap_dance_actions[] = {
  //Tap once for Backspace, twice for Quote
 ...
 * |------+------+------+------+------+------+------+------+------+------+------+------|
 * | GUI  | Ctrl | Alt  | Brite|Lower |    Space    |Raise | Left | Down |  Up  |Right |
 * `-----------------------------------------------------------------------------------'
 */
[_QWERTY] = LAYOUT_planck_grid(
    KC_TAB,  KC_Q,    KC_W,    KC_E,    KC_R,    KC_T,    KC_Y,    KC_U,    KC_I,    KC_O,    KC_P,    KC_BSPC,
    KC_ESC,  KC_A,    KC_S,    KC_D,    KC_F,    KC_G,    KC_H,    KC_J,    KC_K,    KC_L,    TD(ColQot), KC_ENT,
    KC_LSFT, KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, KC_RSFT,
    KC_LGUI, KC_LCTL, KC_LALT, BACKLIT, LT(LOWER, KC_BSPC),   KC_SPC,  KC_SPC,  LT(RAISE, KC_DEL), KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT
),
