...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  //|----+----+----+----+----+----|    |----+----+----+----+----+----|
     LCTL, X3 ,LGUI, X1, BSPC,SPC ,      SPC, DEL, X2 ,RALT, UP ,RGHT
  //`----+----+----+----+----+----'    `----+----+----+----+----+----'
  ),
...
/* Adjust (Lower + Raise)
 * ,-----------------------------------------------------------------------------------.
 * |Reset |      |RGB Tg|RGB Md|Hue Up|Hue Dn|Sat Up|Sat Dn|Val Up|Val Dn|Spd Up|Spd Dn|
 * |------+------+------+------+------+-------------+------+------+------+------+------|
 ...
 */
  [_ADJUST] = LAYOUT( \
    RESET  , _______, RGB_TOG, RGB_MOD, RGB_HUI, RGB_HUD, RGB_SAI, RGB_SAD, RGB_VAI, RGB_VAD, RGB_SPI, RGB_SPD, \
